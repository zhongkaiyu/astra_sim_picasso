...
def get_project_dir() -> Path:
    # congestion_aware/ is parents[2] (script now lives under backend/astrasim_runner/)
...
def get_cache_dir() -> Path:
    # cache_db/ is kept at congestion_aware/ root
    return Path(__file__).resolve().parents[2] / "cache_db"
