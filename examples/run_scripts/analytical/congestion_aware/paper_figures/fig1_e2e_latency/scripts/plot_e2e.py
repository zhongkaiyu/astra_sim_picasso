...
MODELS = [
    ...
    ("DeepSeek-V3 MLA", {
        bs: str(BASE / "paper_figures/fig1_e2e_latency/data/deepseek_v3_mla_fig1.json")
        for bs in [1, 4, 16, 32]
    }),
]

# DeepSeek-V3 MLA 数据格式不同, 需要特殊加载
MLA_DATA_PATH = str(BASE / "paper_figures/fig1_e2e_latency/data/deepseek_v3_mla_fig1.json")
_mla_cache = None
